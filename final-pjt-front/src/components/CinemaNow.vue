            ...
            <div class="cardbox d-flex flex-wrap">
                <div v-for="(movie, index) in movies" :key="index" class="card items my-2">
                    ...
                    <div class="card-body text-center" style="position: relative;">
                        ...
                        <hr>
                        <span class="smt">{{ movie.genre }} | {{ movie.runtime }} | <span class="text-warning">★</span>{{ movie.score }}</span>
                        <br>
...
export default {
    ...
    async created() {
        const response = await axios.get('http://127.0.0.1:8000/movies/cinemanow/');
...
/* .imgbox {
    background: linear-gradient(#0a0c0d, #212529)
} */
