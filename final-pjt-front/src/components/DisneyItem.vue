...
<div style="width:1800px;">
  ...
  <div v-if="ottData" style="margin-top:100px; margin-left:30px;">
    <div id="title" class="title">DISNEY CHART</div>
    <hr>
        ...
        <div class="d-flex">
          ...
          <div class="d-flex flex-column">
            <div class="d-flex">
              ...
              <div class="mt-3">
                <p class="fs-4 text">지금 Disney에서</p>
                <p class="fs-1 text">번째로</p>
                <p class="fs-4 text">인기 많은 영화에요.</p>
              </div>
            </div>
            <div class="ml-5">
              <button class="btn btn-outline-danger"><img src="@/assets/disney.png" alt="logo" class="mr-2" style="width:24px; height:24px;">Disney로 보러가기 ></button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    async fetchOttData() {
      try {
        const response = await axios.get('http://127.0.0.1:8000/movies/api/ott/?page=4');
